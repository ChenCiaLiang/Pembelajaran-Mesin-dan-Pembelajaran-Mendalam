...
model_path = 'C:\Users\Lenovo\OneDrive\Documents\K\S 5\PMdPM\Pembelajaran-Mesin-dan-Pembelajaran-Mendalam\Tugas_B_11839\GBT_HeartDisease_model.pkl'
model = os.path.join(model_path, 'GBT_heartDisease_model.pk1')
...
FastingBS = st.selectbox("Fasting BS", ["1", "e"])
...
input_data = [[input_sex_F, input_sex_M, input_cpain_ASY,
    ...
    input_restecg_LVH, input_restecg_NORMAL, input_restecg_ST, input_anginaN,
    input_anginaY, input_STslope_down, input_STslope_flat, input_STslope_up, Age,
...
if st.button("Prediksi"):
    ...
    st.write(f"Orang tersebut diprediksi **{outcome [gbt_model_prediction[0]]}**")