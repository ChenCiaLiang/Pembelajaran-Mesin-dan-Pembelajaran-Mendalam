...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1839</h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory = r'C:\Users\Lenovo\OneDrive\Documents\K\S 5\PMdPM\Pembelajaran-Mesin-dan-Pembelajaran-Mendalam\MODUL\3 Supervised Learning\Supervised Learning (Praktek)\Tugas3_B_11839\SVR_IPK_model.pkl'
    ...
    if os.path.exists(model_path):
        ...
        kkm_ing1 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 1.1", 0.0, 100.0)
        kkm_ing2 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 1.2", 0.0, 100.0)
        kkm_ing3 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 2.1", 0.0, 100.0)
        kkm_ing4 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 2.2", 0.0, 100.0)
